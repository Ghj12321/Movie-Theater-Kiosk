...
namespace MiniProject1
{
    public partial class Form5 : Form
    {
        ...
        int i_seatcount = 0;
        int i_FullSeat = 48;
        public static bool movie2_1 = false;
        List<string> list = new List<string>();
        List<Button> buttonList = new List<Button>();
        public static List<Button> movie2_1_buttons_Clear = new List<Button>();
        double d_allsum = 0;
        int i_people = 0;
        Button button;
        ...
        private void btn_A1_H13_Click(object sender, EventArgs e)
        {
            ...
            if (i_people > i_seatcount)
            {
                if (button.Enabled == true)
                {
                    ...
                    i_seatcount++;
                    movie2_1_buttons_Clear.Add(button);
                }
            }
            else
            {
        ...
        public void Get_Moive2_1(string time)
        {
        ...
        private void Form5_Load(object sender, EventArgs e)
        {
            ...
            pictureBox1.Load(@"C:\C#\MiniProject1\bin\Movie2.jpg");
        }
        ...
        private void numericUpDown_Adult_ValueChanged(object sender, EventArgs e)
        {
            ...
            if (i_people < movie2_1_buttons_Clear.Count)
            {
                movie2_1_buttons_Clear[movie2_1_buttons_Clear.Count - 1].BackColor = SystemColors.Control;
                movie2_1_buttons_Clear.RemoveAt(movie2_1_buttons_Clear.Count - 1);
                i_seatcount--;
            }
        ...
        private void btn_Reserve_Click(object sender, EventArgs e)
        {
            ...
            //Form9 form9 = new Form9(lb_Pay.Text);
            //form9.ShowDialog();
            //this.Close();
        }
        ...
        {
            foreach (var item in movie2_1_buttons_Clear)
            {
                item.Enabled = true;
                item.BackColor = SystemColors.Control;
            }
